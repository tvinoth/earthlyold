...
if( !defined( 'BDPW_VERSION' ) ) {
	define( 'BDPW_VERSION', '2.2.3.1' ); // Version of plugin
}
if( !defined( 'BDPW_NAME' ) ) {
	define( 'BDPW_NAME', 'Blog Designer' ); // Version of plugin
}
if( !defined( 'BDPW_DIR' ) ) {
...
if(!defined( 'BDPW_PLUGIN_LINK' ) ) {
	define( 'BDPW_PLUGIN_LINK', 'https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=WP-Plugins&utm_campaign=Features-PRO' ); // Plugin link
}
