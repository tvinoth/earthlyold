			...
			<div id="post-body-content">
						...
						<div class="inside">
							<table class="form-table">
								<tbody>
									...
									<tr>
										<th>
											<label><?php _e('Documentation', 'blog-designer-for-post-and-widget'); ?></label>
										</th>
										<td>
											<a class="button button-primary" href="https://docs.essentialplugin.com/blog-designer-post-and-widget/" target="_blank"><?php _e('Check Documentation', 'blog-designer-for-post-and-widget'); ?></a>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<div class="meta-box-sortables">
					<div class="postbox">
						<div class="postbox-header">
							<h2 class="hndle">
								<span><?php _e( 'Need Support & Solutions?', 'blog-designer-for-post-and-widget' ); ?></span>
							</h2>
						</div>
						<div class="inside">
							<table class="form-table">
								<tbody>
									<tr>
										<td>
											<p><?php _e('Boost your <b style="color:#FF5D52;">web site, landing pages & conversions.</b>', 'blog-designer-for-post-and-widget'); ?></p> <br/>
											
											<a class="button button-primary button-orange" href="<?php echo BDPW_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Blog-Designer&utm_campaign=Check-Designs-Solutions" target="_blank"><?php _e('Boost Design', 'blog-designer-for-post-and-widget'); ?></a>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo BDPW_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Blog-Designer&utm_campaign=How-It-Work" target="_blank"><?php _e('Go Premium ', 'blog-designer-for-post-and-widget'); ?></a>
