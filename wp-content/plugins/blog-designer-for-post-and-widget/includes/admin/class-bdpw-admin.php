...
class Bdpw_Admin {
	...
	function bdpw_register_menu() {
		...
		add_submenu_page( 'bdpw-about', __('Upgrade to PRO - Blog Designer', 'blog-designer-for-post-and-widget'), '<span style="color:#ff2700">'.__('Upgrade to PRO', 'blog-designer-for-post-and-widget').'</span>', 'manage_options', 'bdpw-premium', array($this, 'bdpw_premium_page') );
	}
