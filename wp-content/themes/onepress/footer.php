			...
			<div class="container">
				<div class="row">	
					<div class="col-md-7">
						...
						<span><i class="fas fa-globe"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;www.earthlyvibes.co</span>&nbsp;&nbsp;
					</div>
					<div class="col-md-2">
					</div>
					<div class="col-md-3">
						<ul style="padding-left: 160px !important;list-style:none;">
							<li style="float:left;"><i class="fab fa-instagram"></i>&nbsp;&nbsp;&nbsp;</li>&nbsp;&nbsp;&nbsp;&nbsp;
							<li style="float:left;"><i class="fab fa-pinterest"></i>&nbsp;&nbsp;&nbsp;</li>&nbsp;&nbsp;&nbsp;&nbsp;
							<li style="float:left;"><i class="fab fa-facebook-square"></i></li>
						</ul>	
					</div>
				</div>
